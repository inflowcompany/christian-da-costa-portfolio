...
// Canonical domain [A VALIDAR]. Netlify provides the URL at build time.
const baseURL: string = (
  process.env.NEXT_PUBLIC_SITE_URL || process.env.DEPLOY_PRIME_URL || process.env.URL || "http://localhost:3100"
).replace(/\/$/, "");
